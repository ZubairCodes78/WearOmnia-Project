...
const SLIDES = [
  {
    ...
    description: 'Simple, modest and stylish clothing for women.',
  ...
  },
  {
    ...
    description: 'Comfortable and elegant outfits for everyday wear.',
  ...
  },
  {
    ...
    description: 'Modern Pakistani fashion with simple designs.',
