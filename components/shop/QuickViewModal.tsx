...
export const QuickViewModal: React.FC<QuickViewModalProps> = ({ product, onClose }) => {
  ...
  return (<>
    <div className="fixed inset-0 z-50 overflow-y-auto bg-charcoal/70 backdrop-blur-md flex items-center justify-center p-3 sm:p-6">
      <div className="bg-offwhite w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl relative border border-champagne">
        <button
          onClick={onClose}
