  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-16 left-4 sm:bottom-20 sm:right-6 sm:left-auto z-40 flex items-center gap-2 bg-gradient-to-r from-[#D4AF37] to-[#C5A028] text-black p-2.5 sm:px-4 sm:py-3 rounded-full shadow-2xl hover:shadow-[#D4AF37]/40 font-sans pb-safe"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-16 left-4 sm:left-auto sm:bottom-8 sm:right-8 z-50 w-[calc(100%-32px)] sm:w-[400px] h-[500px] sm:h-[600px] max-h-[70vh] sm:max-h-[80vh] bg-[#141414] border border-[#262626] rounded-2xl shadow-2xl flex flex-col overflow-hidden pb-safe"
          >
