...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#06191B] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-[#0A2528] text-[#FAF8F5] w-full max-w-md p-8 sm:p-10 rounded-3xl shadow-2xl border border-[#D4AF37]/35 space-y-6 text-center relative z-10 admin-card-3d">
          ...
          <form onSubmit={handle2FAVerify} className="space-y-4 text-left">
            ...
            {!isRecoveryMode ? (
              <div>
                ...
                <input
                  ...
                  className="w-full text-center tracking-[0.4em] font-mono text-2xl py-3.5 bg-[#06191B] rounded-xl text-[#FAF8F5] border border-[#D4AF37]/35 focus:outline-none focus:ring-1 focus:ring-[#D4AF37]"
                />
              </div>
            ) : (
              <div>
                ...
                <input
                  ...
                  className="w-full text-center tracking-[0.2em] font-mono text-base py-3.5 bg-[#06191B] rounded-xl text-[#FAF8F5] border border-[#D4AF37]/35 focus:outline-none focus:ring-1 focus:ring-[#D4AF37]"
                />
              </div>
            )}
            ...
            <div className="flex items-center justify-between text-[11px] pt-2 border-t border-[#D4AF37]/15">
              ...
              <button
                ...
                className="text-[#FAF8F5]/60 hover:text-white transition-colors"
              >
                Back to Login
              </button>
            </div>
        ...
        <div className="pt-2">
          <p className="text-[11px] text-[#FAF8F5]/60 flex items-center justify-center gap-1.5 font-sans">
            <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /> End-to-End Enterprise Encryption (2FA Protected)
          </p>
        </div>
      </div>
    </div>
